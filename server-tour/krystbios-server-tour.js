...
html body #what#what .kb-grid{align-items:stretch!important;gap:24px!important}
html body #what#what .kb-grid>.kb-card{height:100%!important;padding:34px!important}
html body #what#what .kb-grid>.kb-card>h3{margin:0 0 24px!important}
html body #what#what .kb-grid>.kb-card>p{margin:0!important;color:var(--kt-muted)!important;font-size:18px!important;font-weight:400!important;line-height:1.72!important;text-align:left!important}
html body #what#what .kb-grid>.kb-card>p+p{margin-top:16px!important}
...
html body #the-difference#the-difference .kb-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:24px!important;width:100%!important;max-width:1040px!important;margin-left:auto!important;margin-right:auto!important;border:0!important}
...
html body #why-it-matters#why-it-matters h2{margin-bottom:0!important}
html body #why-it-matters#why-it-matters .kb-lead{margin-top:20px!important}
  ...
  function init(){
    ...
    if(difference){
      ...
      if(inner&&title&&grid){
        ...
        summary.textContent='KrystBios is a Runtime Governance Layer, positioned as Critical Control AI Infrastructure. That means it governs the AI system while it operates. Governance spans the full operating lifecycle, from startup verification and runtime decisions to enforcement, recovery, and evidence.';
